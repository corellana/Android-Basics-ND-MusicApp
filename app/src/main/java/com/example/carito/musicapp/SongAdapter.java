    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        songListItemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                songIntent.putExtra(Constants.SONG_NAME, currentSong.getSongName());
                songIntent.putExtra(Constants.ARTIST_NAME, currentSong.getArtistName());
                songIntent.putExtra(Constants.ALBUM_NAME, currentSong.getAlbumName());
                songIntent.putExtra(Constants.ALBUM_ICON, currentSong.getAlbumIcon());
